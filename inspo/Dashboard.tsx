  ...
  useEffect(() => {
    const fetchCompanies = async () => {
      try {
        ...
        // First try to fetch without authentication to test the API connection
        try {
          console.log("Testing API connection without authentication...");
    ...
    fetchCompanies();
  }, [getToken, selectedCompany, currentUser]);
